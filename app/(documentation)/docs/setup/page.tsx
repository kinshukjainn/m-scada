      ...
      <main className="max-w-[1400px] w-full mx-auto px-6 py-12 lg:py-16 grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_250px] gap-12 lg:gap-16 min-w-0">
        ...
        <article className="max-w-none min-w-0 break-words">
          ...
          <section className="mb-16 min-w-0" id="local-setup">
            ...
            <div className="bg-[#1b1b1b] rounded-2xl overflow-hidden border border-[#333] shadow-sm mb-6">
            ...
            <div className="rounded-2xl p-5 bg-[#1b1b1b] border-l-4 border-l-[#8cb4ff] border border-[#333]">
              <p className="text-gray-300 text-sm font-normal leading-relaxed m-0">
                ...
                <code className="bg-[#2d2d2d] text-[#8cb4ff] border border-[#444] px-1.5 py-0.5 font-mono rounded-2xl text-xs">
                  http://localhost:3000
                </code>{" "}
                by default.
              </p>
          ...
          <section className="mb-16 min-w-0" id="tech-stack">
            ...
            <p className="text-gray-200 font-normal leading-relaxed mb-8 text-[16px]">
              The{" "}
              <code className="bg-[#1b1b1b] text-[#8cb4ff] border border-[#333] px-1.5 py-0.5 font-mono rounded-2xl text-sm">
                package.json
              </code>{" "}
            ...
            <ul className="space-y-4 text-gray-200 font-normal text-[15px] mb-10 pl-1">
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong className="text-white font-mono font-semibold text-sm bg-[#1b1b1b] border border-[#333] px-1.5 py-0.5 rounded-2xl">
                    next (16.1.6)
                  </strong>{" "}
                  &{" "}
                  <strong className="text-white font-mono font-semibold text-sm bg-[#1b1b1b] border border-[#333] px-1.5 py-0.5 rounded-2xl">
          ...
          <section className="mb-16 min-w-0" id="scripts">
            ...
            <div className="overflow-x-auto border border-[#333] rounded-2xl shadow-sm bg-[#1b1b1b]">
                ...
                <tbody className="divide-y divide-[#333]">
                  ...
                  <tr className="hover:bg-[#2d2d2d] transition-colors text-gray-300 font-normal">
                    ...
                    <td className="px-5 py-4 leading-relaxed whitespace-normal">
                      ...
                      <code className="bg-[#121212] px-1.5 py-0.5 rounded-2xl border border-[#333]">
                        .next
                      </code>{" "}
                      directory.
                    </td>
