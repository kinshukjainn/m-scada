        ...
        <article className="max-w-none min-w-0 break-words">
          ...
          <section className="mb-16 min-w-0" id="anatomy">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
              <div className="bg-[#1b1b1b] border border-[#333] rounded-md p-6 sm:p-8 shadow-sm hover:border-[#444] transition-colors">
            ...
            <div className="rounded-md p-6 sm:p-8 mt-8 bg-[#1b1b1b] border-l-4 border-l-amber-500 border border-[#333] shadow-sm">
          ...
          <section className="mb-16 min-w-0" id="distribution">
            ...
            <ul className="space-y-6 bg-[#1b1b1b] border border-[#333] rounded-md p-6 sm:p-8 shadow-sm text-gray-200 font-normal text-[15px] m-0">
